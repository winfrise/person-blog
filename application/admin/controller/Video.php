...
class Video extends Common  {
    ...
    public function index(){
        ...
        $data=model('video')->adminGetVideoAllDataToPage($param);
    ...
    public function addPost(){
        if($this->request->isPost()){
            ...
            $result =$this->validate($params,'Video');
            if($result !== true){
                $return['msg']=$result;
                return $return;
            }
    ...
    public function edit(){
        ...
        $data=model('video')->adminFindDataToId($id);
        if($id == 0 || $data == false){
            $this->error('ID错误');
        }
    ...
    public function removeCategory(){
        if($this->request->isPost()){
            ...
            $rm=model('video')->remove_category($param['ids'],$param['to_category_id']);
            if($rm !== false){
                $arr['code']=200;
                $arr['msg']='移动成功';
                return $arr;
