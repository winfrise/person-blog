...
class Form {
    ...
    static public function file($name, $value, $label, $description='', $placeholder='', $file_type='images', $file_ext='', $title='',$id='image' ) {
        ...
        $string .= '        <input type="text" name="'.$name.'" value="'.$value.'" lay-verify="" autocomplete="off" placeholder="'.$placeholder.'" class="layui-input">
                            <input type="file" name="file" lay-method="post" lay-type="'.$file_type.'" lay-ext="'.$file_ext.'" lay-title="'.$title.'" class="layui-upload-file" id="'.$id.'">';
        $string .= '    </div>
        ...
        $string = '<div class="layui-form-item">
                        ...
                        <div class="layui-input-inline input-custom-width">';
        $string .= '        <input type="text" name="'.$name.'" value="'.$value.'" lay-verify="" autocomplete="off" placeholder="'.$placeholder.'" class="layui-input">
                            <div class="layui-btn layui-box layui-upload-button" id="' . $id .'" lay-method="post" lay-type="'.$file_type.'" lay-ext="'.$file_ext.'" lay-title="'.$title.'">
                               <i class="layui-icon layui-icon-add-1"></i> 图片
                            </div>';
        $string .= '    </div>
                        <div class="layui-form-mid layui-word-aux">'.$description.'</div>
                    </div>';
    ...
    static public function umeditor($name, $value='',$label, $width ='100%', $height = '500',$toolbar = FALSE,$id='umeditor') {
        ...
        $string .= '<link rel="stylesheet" href="__TMPL__/umeditor/themes/default/css/umeditor.css">';
        $string .= '<script type="text/javascript" src="__TMPL__/umeditor/third-party/jquery.min.js"></script>';
        $string .= '<script type="text/javascript" src="__TMPL__/umeditor/umeditor.config.js"></script>';
        $string .= '<script type="text/javascript" src="__TMPL__/umeditor/umeditor.min.js"></script>';
        $string .= '<script type="text/javascript" src="__TMPL__/umeditor/lang/zh-cn/zh-cn.js"></script>';
