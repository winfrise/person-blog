...
class PHPExcel_CachedObjectStorage_SQLite3 extends PHPExcel_CachedObjectStorage_CacheBase implements PHPExcel_CachedObjectStorage_ICache
{
    ...
    /**
     * Prepared statement for a SQLite3 update_sql query
     *
     * @var SQLite3Stmt
     */
    private $updateQuery;
     ...
     *
     * @param    string            $pCoord        Coordinate address of the cell to update_sql
     * @param    PHPExcel_Cell    $cell        Cell to update_sql
