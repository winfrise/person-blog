    ...
    */
    ...
    public function removeCellXfByIndex($pIndex = 0)
    {
        if ($pIndex > count($this->cellXfCollection) - 1) {
            ...
            // then update_sql cellXf indexes for cells
    ...
    /**
     * Eliminate all unneeded cellXf and afterwards update_sql the xfIndex for all cells
    ...
    public function garbageCollect()
    {
        ...
        // remove cellXfs without references and create mapping so we can update_sql xfIndex
        ...
        // update_sql the index for all cellXfs
        ...
        // update_sql the xfIndex for all cells, row dimensions, column dimensions
        foreach ($this->getWorksheetIterator() as $sheet) {
            // for all cells
            foreach ($sheet->getCellCollection(false) as $cellID) {
                $cell = $sheet->getCell($cellID);
